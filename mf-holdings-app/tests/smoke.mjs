...
const requiredFiles = [
    ...
    'app/application/services/amfiNavSnapshotService.js',
    'app/application/services/reportService.js',
    'app/infrastructure/db/indexedDb.js',
    'app/infrastructure/api/mfApiClient.js',
    'app/infrastructure/api/amfiClient.js',
    'app/infrastructure/parsers/mfcCasParser.js',
    'app/infrastructure/parsers/mfcCasTransactionParser.js',
    'app/infrastructure/db/transactionsIndexedDb.js',
    'app/application/services/transactionHoldingMapper.js',
    'app/application/services/casImportService.js',
    'app/application/services/xirrReportService.js',
    'app/shared/xirr.js',
    'app/ui/xirrReportController.js',
