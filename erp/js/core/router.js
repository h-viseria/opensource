...
/** @typedef {{ path: string, title: string, render: (ctx: RouteContext) => Promise<void>|void, requiresBook?: boolean }} RouteDef */
...
/**
 * Register a route.
 * @param {string} path e.g. "/dashboard" or "/ledgers/:id"
...
/**
 * Set the DOM outlet where pages render.
...
/**
 * Optional guard — return false to cancel navigation.
...
/**
 * Start listening to hash changes and resolve current route.
 */
...
/** List registered routes (debug / nav). */
