...
const BOOK_SCOPED_STORES = Object.freeze([
  ...
  STORES.AUDIT_LOGS,
  STORES.EMPLOYEES,
  STORES.EMPLOYEE_CUSTOM_FIELDS,
  STORES.EMPLOYEE_DOCUMENTS,
  STORES.ATTENDANCE_STATUSES,
  STORES.ATTENDANCE_RECORDS,
  STORES.ATTENDANCE_SETTINGS,
  STORES.LEAVE_TYPES,
  STORES.LEAVE_RECORDS,
  STORES.SALARY_HEADS,
  STORES.EMPLOYEE_SALARY_LINES,
  STORES.PAYROLL_SETTINGS,
  STORES.SALARY_ADJUSTMENTS,
  STORES.PAYROLL_RUNS,
  STORES.PAYROLL_ITEMS,
  STORES.EMPLOYEE_PAYROLL_ACCOUNTS,
]);
